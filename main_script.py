...
left_warped_res = cv2.resize(left_warped, None, fx=0.5, fy=0.5, interpolation=cv2.INTER_CUBIC)
...
right_warped_res = cv2.resize(right_warped, None, fx=0.5, fy=0.5, interpolation=cv2.INTER_CUBIC)

# ------ calculate disparity ------
stereo = cv2.StereoSGBM_create(minDisparity=-64, numDisparities=128, blockSize=21, P1=16, P2=1024)
